//$file${.::Cores_Project::Cortex_M4::state_machine::qm_files::main_qm.c} vvvv
//
// Model: main_model.qm.qm
// File:  ${.::Cores_Project::Cortex_M4::state_machine::qm_files::main_qm.c}
//
...
//
//$endhead${.::Cores_Project::Cortex_M4::state_machine::qm_files::main_qm.c} ^
#include "main_qm.h"
