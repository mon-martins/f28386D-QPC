//$file${.::Cores_Project::CPU2::state_machine::qm_files::main_qm.c} vvvvvvvvv
//
// Model: main_model.qm.qm
// File:  ${.::Cores_Project::CPU2::state_machine::qm_files::main_qm.c}
//
...
//
//$endhead${.::Cores_Project::CPU2::state_machine::qm_files::main_qm.c} ^^^^^^
#include "main_qm.h"
