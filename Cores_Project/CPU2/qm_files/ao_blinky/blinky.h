//$file${.::Cores_Project::CPU2::qm_files::ao_blinky::blinky.h} vvvvvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU2::qm_files::ao_blinky::blinky.h}
//
...
//
//$endhead${.::Cores_Project::CPU2::qm_files::ao_blinky::blinky.h} ^^^^^^^^^^^
#ifndef BLINKY_H_
#define BLINKY_H_
