//$file${.::Cores_Project::CPU2::qm_files::AOs::ao_blinky::blinky.c} vvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU2::qm_files::AOs::ao_blinky::blinky.c}
//
...
//
//$endhead${.::Cores_Project::CPU2::qm_files::AOs::ao_blinky::blinky.c} ^^^^^^
#include "./blinky.h"
...
//$define${CPU2::AOs::AO_BLINKY} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
...
QActive * const p_ao_blinky = &inst_ao_blinky.super;
