//$file${.::Cores_Project::CPU1::state_machine::qm_files::main_qm.c} vvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU1::state_machine::qm_files::main_qm.c}
//
...
//
//$endhead${.::Cores_Project::CPU1::state_machine::qm_files::main_qm.c} ^^^^^^
#include "main_qm.h"
