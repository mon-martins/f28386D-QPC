//$file${.::Cores_Project::CPU1::qm_files::AOs::ao_blinky::blinky.h} vvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU1::qm_files::AOs::ao_blinky::blinky.h}
//
...
//
//$endhead${.::Cores_Project::CPU1::qm_files::AOs::ao_blinky::blinky.h} ^^^^^^
#ifndef BLINKY_H_
#define BLINKY_H_
