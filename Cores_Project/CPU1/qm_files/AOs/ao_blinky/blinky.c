//$file${.::Cores_Project::CPU1::qm_files::AOs::ao_blinky::blinky.c} vvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU1::qm_files::AOs::ao_blinky::blinky.c}
//
...
//
//$endhead${.::Cores_Project::CPU1::qm_files::AOs::ao_blinky::blinky.c} ^^^^^^
#include "./blinky.h"
...
//$define${CPU1::AOs::AO_BLINKY} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
