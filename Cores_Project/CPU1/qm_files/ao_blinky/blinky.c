//$file${.::Cores_Project::CPU1::qm_files::ao_blinky::blinky.c} vvvvvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU1::qm_files::ao_blinky::blinky.c}
//
...
//
//$endhead${.::Cores_Project::CPU1::qm_files::ao_blinky::blinky.c} ^^^^^^^^^^^
#include "./blinky.h"
