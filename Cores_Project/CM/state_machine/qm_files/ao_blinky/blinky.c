//$file${.::Cores_Project::CM::state_machine::qm_files::ao_blinky::blinky.c} v
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CM::state_machine::qm_files::ao_blinky::blinky.c}
//
...
//
//$endhead${.::Cores_Project::CM::state_machine::qm_files::ao_blinky::blinky.c} 
#include "./blinky.h"
