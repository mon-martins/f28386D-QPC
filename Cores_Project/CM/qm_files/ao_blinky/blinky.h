//$file${.::Cores_Project::CM::qm_files::ao_blinky::blinky.h} vvvvvvvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CM::qm_files::ao_blinky::blinky.h}
//
...
//
//$endhead${.::Cores_Project::CM::qm_files::ao_blinky::blinky.h} ^^^^^^^^^^^^^
#ifndef BLINKY_H_
#define BLINKY_H_
