//$file${.::Cores_Project::CM::qm_files::AOs::ao_blinky::blinky.c} vvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CM::qm_files::AOs::ao_blinky::blinky.c}
//
...
//
//$endhead${.::Cores_Project::CM::qm_files::AOs::ao_blinky::blinky.c} ^^^^^^^^
#include "./blinky.h"
...
//$define${CM::AOs::AO_BLINKY} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
