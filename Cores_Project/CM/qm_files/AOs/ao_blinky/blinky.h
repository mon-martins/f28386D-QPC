//$file${.::Cores_Project::CM::qm_files::AOs::ao_blinky::blinky.h} vvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CM::qm_files::AOs::ao_blinky::blinky.h}
//
...
//
//$endhead${.::Cores_Project::CM::qm_files::AOs::ao_blinky::blinky.h} ^^^^^^^^
#ifndef BLINKY_H_
#define BLINKY_H_
...
//$declare${CM::AOs::AO_BLINKY} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
